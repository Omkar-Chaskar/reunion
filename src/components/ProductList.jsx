...
function ProductList() {
  ...
  const { product: filteredProducts } = useFilter();

  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
		{filteredProducts.map((product) => {
			return (
				<div className="relative mx-auto w-full" key={product.id}>
        <a
          href="/"
          ...
          <div className="shadow p-4 rounded-lg bg-white">
            <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
              <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                <div className="absolute inset-0">
                  <img src={product.img} alt={product.add1}/>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
              <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                ...
                <span className="mt-2 xl:mt-0">{product.location}</span>
              </p>
              <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                <svg
                  className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                ...
                <span className="mt-2 xl:mt-0">{product.furnished}</span>
              </p>
              <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                <svg
                  className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                ...
                <span className="mt-2 xl:mt-0">{product.sqft} sq. ft.</span>
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 mt-8">
              <div className="flex justify-end">
                <p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                  ...
                  <span className="text-lg">{product.rent}</span>/m
                </p>
              </div>
            </div>
          </div>
