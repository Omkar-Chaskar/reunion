...
const filterFurnished = (filterState, productData) => {
  switch (filterState.furnish) {
    case "fully-furnished":
      return productData.filter((item) => item.furnish === "Fully Furnished");
    case "partially-furnished":
      return productData.filter((item) => item.furnish === "Partially Furnished");
    case "not-furnished":
      return productData.filter((item) => item.furnish === "Not Furnished");
    default:
      return productData;
  }
};
